...
public class SettlementUnclaimCircleCommand extends Command {

    public SettlementUnclaimCircleCommand() {
        super("circle");
    ...
    protected void execute(NCCommandSender sender) {
        ...
        settlement.unclaimTerritory(player, Shape.CIRCLE, radius);
    }
}
